...
export type Mutation = {
  __typename?: 'Mutation';
  createPost: PostGqlType;
  deletePost: Scalars['Boolean'];
  login: UserResponse;
  logout: Scalars['Boolean'];
  register: UserResponse;
  updatePost: PostGqlType;
};
...
export type PostGqlType = {
  __typename?: 'PostGQLType';
...
export type Query = {
  __typename?: 'Query';
  post?: Maybe<PostGqlType>;
  posts: Array<PostGqlType>;
  userDetails?: Maybe<UserGqlType>;
  users: Array<UserGqlType>;
};
...
export type UserResponse = {
  ...
  user?: Maybe<UserGqlType>;
};

export type RegularUserFragment = { __typename?: 'UserGQLType', id: number, username: string } & { ' $fragmentName'?: 'RegularUserFragment' };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null, user?: { __typename?: 'UserGQLType', id: number, username: string } | null } };
...
export type RegisterMutation = { __typename?: 'Mutation', register: { __typename?: 'UserResponse', errors?: Array<{ __typename?: 'FieldError', field: string, message: string }> | null, user?: { __typename?: 'UserGQLType', id: number, username: string } | null } };

export type PostsQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'PostGQLType', id: number, createdAt: string, updatedAt: string, title: string }> };

export type UserDetailsQueryVariables = Exact<{ [key: string]: never; }>;


export type UserDetailsQuery = { __typename?: 'Query', userDetails?: { __typename?: 'UserGQLType', id: number, username: string } | null };

export const RegularUserFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"RegularUser"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"UserGQLType"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}}]} as unknown as DocumentNode<RegularUserFragment, unknown>;
